                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="productForm" method="post" enctype="multipart/form-data" action="admin/info/save" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label  class="col-sm-2 control-label">日期测试:</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control input-append date form_datetime" readonly id="datetest" name="datetest" maxlength="20"
                                           data-rule="required" value="" placeholder="请输入资讯名称">
                                </div>
                            </div>
