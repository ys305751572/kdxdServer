        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">天地E家小区后台系统</h3>
                </div>
                <div class="panel-body">
                    <form role="form" action="business/login/check" method="post">
                        <fieldset>
                            <div class="form-group  <c:if test="${empty error}">has_error</c:if>">
                                <input class="form-control" placeholder="用户名" name="username" value="${username}" type="text"
                                       autofocus>
