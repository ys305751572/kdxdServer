            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <a href="${contextPath}/admin/saleman/add" class="btn btn-outline btn-primary btn-lg" role="button">添加业务员</a>
                    </div>
                    ...
                    "columnDefs": [
                        {
                            ...
                            "&nbsp;&nbsp;"
                            +
                            "<a title='抢购列表' class='btn btn-primary btn-circle prolist'>" +
