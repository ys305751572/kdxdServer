            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="productForm" method="post" enctype="multipart/form-data" action="admin/saleman/save" class="form-horizontal" role="form">
                            <input type="hidden" id="id" name="id" value = ${saleman.id}>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label">业务员名字:</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="name" name="name" maxlength="20"
                                           data-rule="required" value="${saleman.name}" placeholder="业务员名字">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label">业务员手机:</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="mobile" name="mobile" maxlength="20"
                                           data-rule="required" value="${saleman.mobile}" placeholder="业务员手机">
                                </div>
                            </div>
                            <div class="form-group">
...
//                    $("#id").val(result.data.id)
                    window.location.href = " ${contextPath}/admin/saleman/index";
                } else {
