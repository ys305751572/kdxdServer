        ...
        fn: {
                ...
                kuserList.v.dTable = $bluemobi.dataTable($('#dataTables'), {
                    ...
                    "columnDefs": [
                        {
                            "data": null,
                            "defaultContent":
                            "<a  title='查看' target='_blank' class='btn btn-primary btn-circle edit'>" +
                    ...
                    "createdRow": function (row, data, index) {
                        ...
                        if(data.status == 1){
                            ...
                            $('td', row).eq(1).prepend("<span style='color: red'>【启用】</span>");
                    ...
                    "fnServerParams": function (aoData) {
                        aoData.typeId = $("#mobile").val();
                        aoData.isAdded = $("#nickname").val();
            ...
            settingAdded:function(data){
                $bluemobi.ajax("admin/kuser/modifyStatus", {
                    ...
                    kuserList.fn.responseComplete(result,true);
                })
            },
