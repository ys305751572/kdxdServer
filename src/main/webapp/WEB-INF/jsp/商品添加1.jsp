            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form id="productForm" method="post" enctype="multipart/form-data" action="product/save" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="link" name="link" maxlength="20"
                                           data-rule="required" value="${product.link}" placeholder="请输入商品链接">
                                </div>
                            </div>
