...
CREATE TABLE `business` (
  ...
  CONSTRAINT `business_ibfk_2` FOREIGN KEY (`image_id`) REFERENCES `wx_user` (`id`),
...
INSERT INTO `business` VALUES ('10', 'buss15000010', '和平饭店', null, 'ddd', null, '30.480164', '114.39726', 'ff', null, '4', null, '2015-08-11 14:31:23', '2015-08-12 10:14:13');
...
CREATE TABLE `image` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1429 DEFAULT CHARSET=utf8 COMMENT='图片表';
